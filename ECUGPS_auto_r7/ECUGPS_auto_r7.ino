...
void ReadOBD() {
  ...
  if ((obdflag == ISO9141SLOW) || (obdflag == ISO9141KWP) || (obdflag == KWPSUZ)) {
    ...
    if (bFuelType) {
      ...
      fLPGKm += (fSpeed + fPreviousSpeed) * elapsedmillis/7200000;      // fixed Km formula using trapezoid 12/20/2020
      ...
      fGasKm += (fSpeed + fPreviousSpeed) * elapsedmillis/7200000;      // fixed Km formula using trapezoid 12/20/2020
